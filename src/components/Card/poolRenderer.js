...
const PoolRenderer = (props) => {
  ...
  //   );
  // }
  if (!idoAddress || !tokenName || !tokenSymbol) return null;
      ...
      >
        ...
        <s.Container fd="row">
          <s.Container ai="center" flex={1}>
            ...
            {BigNumber(library.web3.utils.fromWei(softCap)).toFormat(
              2
            ) +
              " " +
              baseCurrencySymbol}
          ...
          <s.Container ai="center" flex={1}>
            ...
            {BigNumber(library.web3.utils.fromWei(hardCap)).toFormat(
              2
            ) +
              " " +
              baseCurrencySymbol}
