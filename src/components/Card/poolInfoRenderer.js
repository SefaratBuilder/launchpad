    ...
    <>{idoInfo ? (
      <s.Container flex={2} ai="center" style={{ margin: 10, minWidth: 400 }}>
        ...
        >
          ...
          <s.SpacerSmall />
          {
            idoInfo.listingRate > 0 && idoInfo.lpPercentage > 0 && <s.Container fd="row" jc="space-between">
          ...
          <s.Container fd="row" jc="space-between">
            ...
            {new Date(parseInt(idoInfo.start) * 1000).toString()}
          </s.Container>
          <s.SpacerSmall />
          <s.Container fd="row" jc="space-between">
            <s.TextID fw="700">End time</s.TextID>
            {new Date(parseInt(idoInfo.end) * 1000).toString()}
          </s.Container>
          <s.SpacerSmall />
          <s.Container fd="row" jc="space-between">
            <s.TextID fw="700">Lock LP until</s.TextID>
            {new Date(parseInt(idoInfo.claim) * 1000).toString()}
          </s.Container>
          <s.SpacerSmall />
        </s.Card>
        <s.SpacerMedium />
